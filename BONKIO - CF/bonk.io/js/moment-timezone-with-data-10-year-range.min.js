!function(a, i) {
    ...
    function E() {
        ...
        var e, r, o, c = function() {
            var a, i, e, r = (new Date).getFullYear() - 2, o = new M(new Date(r,0,1)), c = [o];
            for (e = 1; e < 48; e++)
                (i = new M(new Date(r,e,1))).offset !== o.offset && (a = d(o, i),
                c.push(a),
                c.push(new M(new Date(a.at + 6e4)))),
                o = i;
            for (e = 0; e < 4; e++)
    ...
    function P(a, i) {
        ...
        A[a] = r) : n[a] && i !== P && (e = P(n[a], P)) ? ((r = A[a] = new p)._set(e),
        r.name = s[a],
        r) : null
    }
    function S(a) {
    ...
    function B(a) {
        ...
        return r && !c.isMoment(a) && k(o) && o.add(r.parse(o), "minutes"),
        o.tz(e),
        o
    }
    (e < 2 || 2 == e && r < 6) && L("Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js " + c.version + ". See momentjs.com"),
    p.prototype = {
        _set: function(a) {
            this.name = a.name,
            this.abbrs = a.abbrs,
        ...
        parse: function(a) {
            ...
            for (o = 0; o < t; o++)
                ...
                e = A[o + 1],
                r = A[o ? o - 1 : o],
                i < e && B.moveAmbiguousForward ? i = e : r < i && B.moveInvalidForward && (i = r),
                c < n[o] - 6e4 * i)
                    return A[o];
            return A[t]
        },
        ...
        offset: function(a) {
            return L("zone.offset has been deprecated in favor of zone.utcOffset"),
    ...
    B.zoneExists = function a(i) {
        ...
        L("moment.tz.zoneExists('" + i + "') has been deprecated in favor of !moment.tz.zone('" + i + "')")),
        !!P(i)
    }
    ,
    B.guess = function(a) {
    ...
    c.updateOffset = function(a, i) {
        ...
        if (void 0 === a._z && (r && k(a) && !a._isUTC && (a._d = c.utc(a._a)._d,
        a.utc().add(r.parse(a), "minutes")),
        a._z = r),
        a._z)
            if (e = a._z.utcOffset(a),
            Math.abs(e) < 16 && (e /= 60),
            void 0 !== a.utcOffset) {
                var o = a._z;
                a.utcOffset(-e, i),
    ...
    O.tz = function(a, i) {
        if (a) {
            ...
            return this._z = P(a),
            this._z ? c.updateOffset(this, i) : L("Moment Timezone has no data for " + a + ". See http://momentjs.com/timezone/docs/#/data-loading/."),
            this
        }
        if (this._z)
            return this._z.name
    ...
    c.tz.setDefault = function(a) {
        return (e < 2 || 2 == e && r < 9) && L("Moment Timezone setDefault() requires Moment.js >= 2.9.0. You are using Moment.js " + c.version + "."),
        c.defaultZone = a ? P(a) : null,
        c
    }
    ;
    var y = c.momentProperties;
    return "[object Array]" === Object.prototype.toString.call(y) ? (y.push("_z"),
    y.push("_a")) : y && (y._z = null),
    _({
        version: "2019a",
